...
ADD_DEFINITIONS(-DENABLE_WINCEONWINDOWS=0)
ADD_DEFINITIONS(-DJSCCOLLECTOR_VIRTUALMEM_RESERVATION=0x200000)
ADD_DEFINITIONS(-DENABLE_WINCEONWINDOWS=0)
ADD_DEFINITIONS(-DENABLE_CONTEXT_MENUS=0)
ADD_DEFINITIONS(-DENABLE_TEXT_CARET=0)
ADD_DEFINITIONS(-DENABLE_PAN_SCROLLING=0)
ADD_DEFINITIONS(-DENABLE_FILE_SYSTEM=0)

INCLUDE_DIRECTORIES(3rdparty/ce-compat)

IF (MSVC)
    ADD_DEFINITIONS(/MT /O1)
ENDIF ()
...
WEBKIT_FEATURE(ENABLE_WINCEONWINDOWS "Enable running under windows platform" DEFAULT OFF)
WEBKIT_FEATURE(ENABLE_CONTEXT_MENUS "Enable context menus" DEFAULT OFF)
WEBKIT_FEATURE(ENABLE_TEXT_CARET "Enable text caret" DEFAULT OFF)
WEBKIT_FEATURE(ENABLE_PAN_SCROLLING "Enable pan Scrolling" DEFAULT OFF)
