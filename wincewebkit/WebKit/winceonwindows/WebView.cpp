...
#endif
{
	...
	m_windowHandle = CreateWindow(kWebViewWindowClassName, 0, WS_CHILD /*| WS_HSCROLL | WS_VSCROLL*/,
		0, 0, GetSystemMetrics(SM_CXSCREEN), GetSystemMetrics(SM_CYSCREEN)/*0, 0, 619, 680*/, hwnd, 0, WebCore::instanceHandle(), 0);
#else
	m_windowHandle = CreateWindow(kWebViewWindowClassName, 0, WS_CHILD /*| WS_HSCROLL | WS_VSCROLL*/,
	...
	settings->setStandardFontFamily(_T("宋体"));
    settings->setDefaultFixedFontSize(38);
    settings->setDefaultFontSize(38);
    settings->setMinimumFontSize(38);
    settings->setMinimumLogicalFontSize(38);
